...
repl_grid = """             {/* Grid Details Re-designed */}
                ...
                <div className="md:col-span-5 flex flex-col gap-8">
                   ...
                   <div className="bg-error/5 p-6 rounded-[32px] border border-error/20 shadow-sm flex-1 relative overflow-hidden">
                      ...
                      <div className="space-y-2 relative z-10">
                         ...
                         <p className="font-black text-on-surface text-lg leading-none">{selectedOperator.contacto_emergencia_nombre || 'No registrado'}</p>
