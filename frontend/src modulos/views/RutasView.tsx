...
import { Map as MapIcon, Layers, Settings, Maximize2, MoreVertical, Route, Navigation } from 'lucide-react';
             ...
             {DUMMY_ROUTES.map((route, idx) => (
                ...
                >
                  <div className="flex justify-between items-start mb-2">
                     ...
                     <button className="text-on-surface-variant hover:text-on-surface p-1"><MoreVertical size={16} /></button>
                  </div>
                  <div className="flex items-center gap-3 text-xs">
                     ...
                     <span className="flex items-center text-on-surface-variant"><Route size={14} className="mr-1" /> {route.distance}</span>
                     <span className="flex items-center text-on-surface-variant"><Navigation size={14} className="mr-1" /> {route.activeUnits} Unidades</span>
                  </div>
                </div>
             ))}
          </div>
