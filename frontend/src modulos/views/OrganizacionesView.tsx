...
import { Search, Filter, Plus, Building2, Eye, Edit2, Shield, MapPin, Activity } from 'lucide-react';
                ...
                <tr key={row.id} className="hover:bg-surface-container-low transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center">
                       <Building2 size={16} className="mr-2 text-primary-fixed-variant" />
...
function CreateOrgModal({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
        ...
        <div className="md:col-span-7 space-y-5">
           ...
           <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1.5 col-span-2 sm:col-span-1">
                ...
                <div className="flex">
                   <select className="bg-surface-container-lowest border border-r-0 border-outline-variant rounded-l-lg px-2 py-2 text-sm outline-none focus:border-primary focus:ring-1 focus:ring-primary z-10 w-16">
                     <option>J</option>
                     <option>G</option>
                     <option>V</option>
                   </select>
              ...
              <div className="space-y-1.5 col-span-2">
                ...
                <select className="w-full bg-surface-container-lowest border border-outline-variant rounded-lg px-3 py-2 text-sm outline-none focus:border-primary focus:ring-1 focus:ring-primary">
