                  ...
                  <tr key={org.rif} className={`hover:bg-surface-container-low/60 transition-colors group ${selectedRifs.includes(org.rif) ? 'bg-primary/[0.04] hover:bg-primary/[0.07]' : ''}`}>
                    ...
                    <td className="px-4 py-3 align-middle">
                      <div className="flex items-center gap-1 flex-wrap">
                        <span className="px-1.5 py-0.5 rounded text-[10px] font-mono font-bold bg-surface-container-high text-on-surface-variant border border-outline-variant/50 whitespace-nowrap" title="Minibús">M:{org.conteo_minibus}</span>
                        <span className="px-1.5 py-0.5 rounded text-[10px] font-mono font-bold bg-surface-container-high text-on-surface-variant border border-outline-variant/50 whitespace-nowrap" title="Bus">B:{org.conteo_bus}</span>
                        <span className="px-1.5 py-0.5 rounded text-[10px] font-mono font-bold bg-surface-container-high text-on-surface-variant border border-outline-variant/50 whitespace-nowrap" title="Otro">O:{org.conteo_otro}</span>
                        <span className="px-1.5 py-0.5 rounded text-[10px] font-mono font-bold bg-primary/8 text-primary border border-primary/15 whitespace-nowrap" title="Urbanas">U:{org.rutas_urbanas}</span>
                        <span className="px-1.5 py-0.5 rounded text-[10px] font-mono font-bold bg-secondary/8 text-secondary border border-secondary/15 whitespace-nowrap" title="Suburbanas">S:{org.rutas_suburbanas}</span>
                      </div>
                    </td>
