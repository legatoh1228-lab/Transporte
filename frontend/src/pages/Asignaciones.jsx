            ...
            >
                <div className="py-4 grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div className="lg:col-span-5 flex flex-col gap-6 lg:border-l border-outline-variant/30 lg:pl-8 pt-4 lg:pt-0 border-t lg:border-t-0 max-h-[75vh] overflow-y-auto custom-scrollbar pr-2 pb-10">
                        ...
                        {/* Route Map Preview */}
                        <div className={`p-6 rounded-[24px] border transition-all duration-500 overflow-visible group ${selectedRouteObj ? 'bg-white dark:bg-[#1A1C1E]/70 dark:backdrop-blur-2xl shadow-[0_8px_30px_rgb(0,0,0,0.06)] dark:shadow-[0_8px_30px_rgba(0,0,0,0.5)] dark:shadow-[inset_0_1px_1px_rgba(255,255,255,0.05)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)] dark:hover:shadow-[0_8px_30px_rgb(0,0,0,0.6)] border-tertiary/30' : 'bg-surface-container-lowest/50 border-outline-variant/50 border-dashed'}`}>
                            ...
                            {selectedRouteObj ? (
                                <div className="flex flex-col gap-4 min-h-[100px]">
                                    <div className="flex items-center gap-4">
                                        <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-tertiary/20 to-tertiary/5 dark:from-tertiary/30 dark:to-tertiary/10 text-tertiary flex items-center justify-center shrink-0 shadow-inner">
                                    ...
                                    {(() => {
                                        ...
                                        return coords.length > 1 ? (
                                            ...
                                            <div className="w-full h-32 rounded-[20px] bg-tertiary/5 dark:bg-tertiary/10 border border-tertiary/20 dark:border-tertiary/30 text-tertiary dark:text-tertiary-container flex flex-col items-center justify-center shadow-inner mt-2" style={{ minHeight: '128px' }}>
                                ...
                                <div className="flex flex-col items-center justify-center text-center text-on-surface-variant/40 h-32 bg-surface-container/30 dark:bg-surface-container-low/50 rounded-[20px] dark:border dark:border-outline-variant/20" style={{ minHeight: '128px' }}>
                        ...
                        {/* Operador Preview */}
                        <div className={`p-6 rounded-[24px] border transition-all duration-500 group ${selectedOperatorObj ? 'bg-white dark:bg-[#1A1C1E]/70 dark:backdrop-blur-2xl shadow-[0_8px_30px_rgb(0,0,0,0.06)] dark:shadow-[0_8px_30px_rgba(0,0,0,0.5)] dark:shadow-[inset_0_1px_1px_rgba(255,255,255,0.05)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)] dark:hover:shadow-[0_8px_30px_rgb(0,0,0,0.6)] border-primary/30' : 'bg-surface-container-lowest/50 border-outline-variant/50 border-dashed'}`}>
                            <div className="flex items-center gap-2 mb-5">
                            ...
                            {selectedOperatorObj ? (
                                <div className="flex items-center gap-5">
                                    {selectedOperatorObj.foto ? (
                                        <img src={selectedOperatorObj.foto} alt="Operador" className="w-[72px] h-[72px] rounded-full object-cover border-[3px] border-white dark:border-white/10 shadow-md dark:shadow-black/50 shrink-0 ring-2 ring-primary/20" />
                                    ) : (
                                        <div className="w-[72px] h-[72px] rounded-full bg-gradient-to-br from-primary/20 to-primary/5 dark:from-primary/30 dark:to-primary/10 border-[3px] border-white dark:border-white/10 shadow-md dark:shadow-black/50 text-primary flex items-center justify-center shrink-0 ring-2 ring-primary/20">
                                ...
                                <div className="flex flex-col items-center justify-center text-center text-on-surface-variant/40 h-24 bg-surface-container/30 dark:bg-surface-container-low/50 rounded-[20px] dark:border dark:border-outline-variant/20">
                        ...
                        {/* Colector Preview */}
                        <div className={`p-6 rounded-[24px] border transition-all duration-500 group ${selectedColectorObj ? 'bg-white dark:bg-[#1A1C1E]/70 dark:backdrop-blur-2xl shadow-[0_8px_30px_rgb(0,0,0,0.06)] dark:shadow-[0_8px_30px_rgba(0,0,0,0.5)] dark:shadow-[inset_0_1px_1px_rgba(255,255,255,0.05)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)] dark:hover:shadow-[0_8px_30px_rgb(0,0,0,0.6)] border-success/30' : 'bg-surface-container-lowest/50 border-outline-variant/50 border-dashed'}`}>
                            <div className="flex items-center gap-2 mb-5">
                            ...
                            {selectedColectorObj ? (
                                <div className="flex items-center gap-5">
                                    {selectedColectorObj.foto ? (
                                        <img src={selectedColectorObj.foto} alt="Colector" className="w-[60px] h-[60px] rounded-full object-cover border-[3px] border-white dark:border-white/10 shadow-md dark:shadow-black/50 shrink-0 ring-2 ring-success/20" />
                                    ) : (
                                        <div className="w-[60px] h-[60px] rounded-full bg-gradient-to-br from-success/20 to-success/5 dark:from-success/30 dark:to-success/10 border-[3px] border-white dark:border-white/10 shadow-md dark:shadow-black/50 text-success flex items-center justify-center shrink-0 ring-2 ring-success/20">
                        ...
                        {/* Vehicle Preview */}
                        <div className={`p-6 rounded-[24px] border transition-all duration-500 group ${selectedVehicleObj ? 'bg-white dark:bg-[#1A1C1E]/70 dark:backdrop-blur-2xl shadow-[0_8px_30px_rgb(0,0,0,0.06)] dark:shadow-[0_8px_30px_rgba(0,0,0,0.5)] dark:shadow-[inset_0_1px_1px_rgba(255,255,255,0.05)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)] dark:hover:shadow-[0_8px_30px_rgb(0,0,0,0.6)] border-secondary/30' : 'bg-surface-container-lowest/50 border-outline-variant/50 border-dashed'}`}>
                            <div className="flex items-center gap-2 mb-5">
                            ...
                            {selectedVehicleObj ? (
                                <div className="flex flex-col gap-5">
                                    {selectedVehicleObj.foto ? (
                                        ...
                                        <div className="w-full h-32 rounded-[20px] bg-gradient-to-br from-secondary/10 to-secondary/5 dark:from-secondary/20 dark:to-secondary/5 border border-secondary/20 dark:border-secondary/30 text-secondary flex items-center justify-center shadow-inner">
                                            <span className="material-symbols-outlined text-[48px] opacity-80">directions_bus</span>
                                        </div>
                                    )}
                                    <div className="flex justify-between items-end bg-surface-container-lowest dark:bg-white/5 p-4 rounded-2xl border border-outline-variant/30 dark:border-white/10 shadow-sm dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.05)] dark:backdrop-blur-lg">
                                        <div className="min-w-0 pr-4">
                                            ...
                                            <div className="flex items-center gap-2 mt-1.5">
                                                ...
                                                <span className="bg-surface-container dark:bg-[#000000]/40 dark:backdrop-blur-xl text-on-surface font-black px-2 py-0.5 rounded text-sm border border-outline-variant/50 dark:border-white/10 shadow-sm dark:shadow-inner">{selectedVehicleObj.placa}</span>
                                            </div>
                                        </div>
                                ...
                                <div className="flex flex-col items-center justify-center text-center text-on-surface-variant/40 h-32 bg-surface-container/30 dark:bg-surface-container-low/50 rounded-[20px] dark:border dark:border-outline-variant/20">
