...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  const navItems = [
    ...
    { label: 'Insumos',        icon: 'inventory',        path: '/insumos' },
    { label: 'Operadores',     icon: 'person_pin',       path: '/operadores' },
    { label: 'Colectores',     icon: 'groups',           path: '/colectores' },
    { label: 'Vinculación',    icon: 'assignment_ind',   path: '/asignaciones' },
