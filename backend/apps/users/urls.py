...
from .views import RegisterView, LoginView, UserViewSet, DashboardStatsView, DashboardComposicionView, UserActivityView, ChangePasswordView, GlobalAuditView, AlertsView, ConsolidadoStatsView
...
urlpatterns = [
    ...
    path('consolidado-stats/', ConsolidadoStatsView.as_view(), name='consolidado-stats'),
