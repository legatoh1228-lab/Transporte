...
class EmpresaOrganizacion(models.Model):
    ...
    razon_social = models.CharField(max_length=255)
    municipio = models.ForeignKey('catalogs.TerritorioMunicipio', on_delete=models.SET_NULL, null=True, blank=True, related_name='organizaciones', verbose_name="Municipio Sede")
    conteo_minibus = models.PositiveIntegerField(default=0, verbose_name="Cantidad Minibus")
    conteo_bus = models.PositiveIntegerField(default=0, verbose_name="Cantidad Bus")
    conteo_otro = models.PositiveIntegerField(default=0, verbose_name="Cantidad Otros")
    rutas_urbanas = models.PositiveIntegerField(default=0, verbose_name="Rutas Urbanas")
    rutas_suburbanas = models.PositiveIntegerField(default=0, verbose_name="Rutas Suburbanas")
    ...
    rep_legal_ci = models.CharField(max_length=15, null=True, blank=True, verbose_name="Cédula Rep. Legal")
    rep_legal_nom = models.CharField(max_length=150, null=True, blank=True, verbose_name="Nombre Rep. Legal")
    telefono = models.CharField(max_length=20, blank=True, null=True)
    correo = models.EmailField(max_length=255, blank=True, null=True)
